              ...
              <el-form :inline="false">
                <el-form-item label="选择表格显示项">
                  ...
                  <el-checkbox-group v-model="checkedTables1" @change="handleCheckedChange1">
                    <el-checkbox v-for="(item,index) in tableOptions1" checked :label="item" :key="index">
                      {{item.label}}
                    </el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
              ...
              >
                <template slot-scope="scope">
                  <el-button
                    size="mini"
                    type="primary"
                    @click="sentTest(scope.$index, scope.row)">测试
                  </el-button>
                  <el-button
                    size="mini"
                    type="success"
                    @click="changeThrough(scope.$index, scope.row)">通过
                  </el-button>
                  <el-button
                    size="mini"
                    type="warning"
                    @click="changeRefused(scope.$index, scope.row)">拒绝
                  </el-button>
              ...
              <el-form :inline="false">
                <el-form-item label="选择表格显示项">
                  ...
                  <el-checkbox-group v-model="checkedTables2" @change="handleCheckedChange2">
                    <el-checkbox v-for="(item,index) in tableOptions2" checked :label="item" :key="index">
                      {{item.label}}
                    </el-checkbox>
                  </el-checkbox-group>
                </el-form-item>
              ...
              >
                <template slot-scope="scope">
                  <el-popover
                    ...
                    <el-button slot="reference" type="text" style="color:#f56c6c">审核未通过,查看原因</el-button>
                  </el-popover>
                  <el-button
                    size="mini"
                    v-else
                    type="text"
                    style="color:#67C23A">审核通过
                  </el-button>
                </template>
              </el-table-column>
    ...
    data() {
      return {
        ...
        tableOptions1: [
          ...
          {
            label: '申请时间', prop: 'createTime', type: 'time'
          },
          {
            label: '群发时间', prop: 'expectTime', type: 'time'
          },
          {
            label: '申请人', prop: 'creator', type: 'normal'
          },
          {
            label: '类型', prop: 'smsType', type: 'filter', formatters: this.filterSendType
          },
          {
