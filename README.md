...
## 目录结构介绍 ##
	...
	|               |-- Meterial          // 素材管理主要入口
	|               |-- HomeDialog        // 首页弹窗管理
	|               |-- HomeSuspension    // 首页浮动窗管理
	|               |-- Startfigure       // 启动图管理
	|           |-- Periodism             // 用户周期管理相关组件
  	|               |-- Periodism         // 用户周期管理入口组件
	|               |-- OperationalEvents // 运营性
	|               |-- SystemEvents      // 系统性
	|               |-- MessageConfig     // 消息配置
	|           |-- RoleManager           // 权限管理相关组件
  	|               |-- SetPermission     // 权限管理入口组件
  	|               |-- UserManager       // 用户管理
  	|               |-- UserListManager   // 用户组管理
  	|               |-- RoleSetting       // 角色管理
  	|               |-- MenuManager       // 菜单管理
  	|           |-- BlockChannels         // 屏蔽渠道相关组件
  	|               |-- BlockChannels     // 屏蔽渠道相管理
  	|           |-- UserFeedback          // 用户反馈相关组件
  	|               |-- UserFeedback      // 用户反馈管理
  	|           |-- GroupsentMsg         //消息群发
	|  				|-- PushGroupsent  	 //push群发
	|  				|-- SmgGroupsent  	 //短信群发
	|  				|-- StandGroupsent   //站内信群发
	|  				|-- TelGroupsent  	 //自动电话群发	
  	|           |-- MassAudit            //群发审核
	|  				|-- PushAudit  	     //push群发审核
	|  				|-- SmgAudit  	 	 //短信群发审核
